        ...
        <>
          {paginatedItems?.length ? (
            ...
            <>
              ...
              <div className='text-center text-[#f58220] font-bold'>No Products Found</div>
            </>
          )}
          ...
          <div className="bg-white p-6 rounded-lg shadow-lg w-auto" onClick={(e) => e.stopPropagation()}>
            ...
            <div className="flex justify-end gap-4">
              ...
              <button
                ...
                className="px-4 py-2 bg-[#f58220] text-white rounded-md text-sm font-medium hover:bg-[#f58220]"
              >
                Confirm Delete
              </button>
            </div>
